...
////// Emissive:
                ...
                float2 node_7411 = (node_1855+node_3702.g*float2(0,0.05));
                float4 _MainTexture_var = tex2D(_MainTexture,TRANSFORM_TEX(node_7411, _MainTexture));
                float2 node_4898 = ((sceneUVs * 2 - 1).rg+node_3702.g*float2(0,0.02));
                ...
                float2 node_2716 = (lerp(node_1855,float2(node_4471,node_4471),_Noiselevel)+node_3702.g*float2(0,0.02));
